...
public class TelaPesquisarVinculo extends javax.swing.JFrame {
                ...
                .addGroup(jpanelInput1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jpanelInput1Layout.createSequentialGroup()
                        .addGroup(jpanelInput1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(txtPesquisar, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(36, 36, 36)
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(this, "Selecione um vinculo para excluir", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }

        // Obtenha o ID do cargo selecionado
        int id_ds = (int) tblDados.getValueAt(selectedRow, 0);

        // Confirme a exclusão
        int option = JOptionPane.showConfirmDialog(this, "Tem certeza que deseja excluir este vinculo?", "Confirmar Exclusão", JOptionPane.YES_NO_OPTION);
        if (option == JOptionPane.YES_OPTION) {
            // Exclua o cargo usando o SintomaController
            try {
                DoencasSintomasController.deleteDS(id_ds);
                JOptionPane.showMessageDialog(this, "Vinculo excluído com sucesso!");
                // Atualize a tabela após a exclusão
                pesquisarDS();
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(this, "Erro ao excluir vinculo: " + ex.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            try {
                ...
                Logger.getLogger(TelaPesquisarVinculo.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            JOptionPane.showMessageDialog(this, "Selecione um vinculo para alterar.", "Aviso", JOptionPane.WARNING_MESSAGE);
        }
    ...
    public void pesquisarDS() throws SQLException {

        String idString = (txtPesquisar.getText()).trim();
        int i = 0; //implementação futura
        ...
        modelo.setRowCount(0);  // Limpa a tabela antes de adicionar os resultados
        
        DoencasSintomasController.searchDS(idString, modelo);
